...
public class caseMgt extends AbstractPageBean {
    ...
    //limingyao Add emergency level radio button
    public Label lblDelayPriValue;
    public Label getLblDelayPriValue() { return lblDelayPriValue; }
    public void setLblDelayPriValue(Label lbl) { lblDelayPriValue = lbl; }
    
    private RadioButton rbNormalDelay ;
    public RadioButton getRbNormalDelay() { return rbNormalDelay; }
    public void setRbNormalDelay(RadioButton rb) {rbNormalDelay = rb; }

    private RadioButton rbImportantDelay ;
    public RadioButton getRbImportantDelay() { return rbImportantDelay; }
    public void setRbImportantDelay(RadioButton rb) {rbImportantDelay = rb; }

    private RadioButton rbUrgentDelay ;
    public RadioButton getRbUrgentDelay() { return rbUrgentDelay; }
    public void setRbUrgentDelay(RadioButton rb) {rbUrgentDelay = rb; }
    
    private PanelLayout pnlPriority = new PanelLayout();
    public PanelLayout getPnlPriority() { return pnlPriority; }
    public void setPnlPriority(PanelLayout pl) {  pnlPriority = pl; }
    
    private StaticText priSettingHeader = new StaticText();
    public StaticText getPriSettingHeader() { return priSettingHeader; }
    public void setPriSettingHeader(StaticText st) { priSettingHeader = st; }
    
    private RadioButton rbNormal ;
    public RadioButton getRbNormal() { return rbNormal; }
    public void setRbNormal(RadioButton rb) {rbNormal = rb; }

    private RadioButton rbImportant ;
    public RadioButton getRbImportant() { return rbImportant; }
    public void setRbImportant(RadioButton rb) {rbImportant = rb; }

    private RadioButton rbUrgent ;
    public RadioButton getRbUrgent() { return rbUrgent; }
    public void setRbUrgent(RadioButton rb) {rbUrgent = rb; }
    
    private Button btnPriSetOK = new Button();
    public Button getBtnPriSetOK() { return btnPriSetOK; }
    public void setBtnPriSetOK(Button b) { btnPriSetOK = b; }

    private Button btnPriSetCancel = new Button();
    public Button getBtnPriSetCancel() { return btnPriSetCancel; }
    public void setBtnPriSetCancel(Button b) { btnPriSetCancel = b; }
    /////////////////////////////////
  ...
  //limingyao
    public String btnPriSetting_action() {
        if (hasSpecSelected()) _sb.setPrioritySetPanelVisible(true);
        return null ;
    }
    public String btnPriSetOK_action() {  
    	if( rbNormal.isChecked() )
    		_sb.setEmergencyLevel(1);
    	else if (rbImportant.isChecked() )
    		_sb.setEmergencyLevel(2);
    	else if ( rbUrgent.isChecked() )
    		_sb.setEmergencyLevel(3);  
    	
    	_sb.setPrioritySetPanelVisible(false);
    	return btnLaunch_action();
    }   
    public String btnPriSetCancel_action() {
        _sb.setPrioritySetPanelVisible(false);
        return null ;
    }
    /////////
    ...
    private void beginCase(YSpecificationID specID) {
        ...
        try {
        	//limingyao Begin Case with emergency level setting
        	if( _sb.hasEmergencyLevelSet() ){
        		if( _sb.getEmergencyLevel() > -1){
        			result = _rm.launchCase(specID, caseData, _sb.getSessionhandle(),
        					_sb.getEmergencyLevel());
        		}
        	}
        	
        	else if (_sb.hasDelayValueSet()) {
