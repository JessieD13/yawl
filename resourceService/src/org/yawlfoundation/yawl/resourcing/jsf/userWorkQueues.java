...
import org.yawlfoundation.yawl.resourcing.jsf.comparator.WorkItemDeadlineComparator;
...
public class userWorkQueues extends AbstractPageBean {
    ...
    private void addItemsToListOptions(Set<WorkItemRecord> queue,
        ...
        //limingyao
        SortedSet<WorkItemRecord> qSorted = new TreeSet<WorkItemRecord>(new WorkItemDeadlineComparator());
