...
//        }
    ...
    //limingyao
    private boolean levelNormalRBSelected = true;
    private boolean levelImportantRBSelected = false;
    private boolean levelUrgentRBSelected = false;

    public boolean isLevelNormalRBSelected() { return levelNormalRBSelected; }

    public void setLevelNormalRBSelected(boolean selected) {
    	levelNormalRBSelected = selected;
    }

    public boolean isLevelImportantRBSelected() { return levelImportantRBSelected; }

    public void setLevelImportantRBSelected(boolean selected) {
    	levelImportantRBSelected = selected;
    }

    public boolean isLevelUrgentRBSelected() { return levelUrgentRBSelected; }

    public void setLevelUrgentRBSelected(boolean selected) {
    	levelUrgentRBSelected = selected;
    }
    
    //private boolean levelNormalDelayedRBSelected = true;
    //private boolean levelImportantDelayedRBSelected = false;
    //private boolean levelUrgentDelayedRBSelected = false;
    /////////
  ...
  //limingyao
    private PanelLayout pnlPriSettingBlockout = new PanelLayout();
    public PanelLayout getPnlPriSettingBlockout() {
        return pnlPriSettingBlockout;
    }
    public void setPnlPriSettingBlockout(PanelLayout panel) {
    	pnlPriSettingBlockout = panel;
    }
    
    private boolean prioritySetPanelVisible = false;
    public boolean isPrioritySetPanelVisible(){
    	return prioritySetPanelVisible;
    }
    public void setPrioritySetPanelVisible(boolean visible){
    	prioritySetPanelVisible = visible;
    }
    
    private int emergencyLevel = -1;
    enum emergencyLevelChoice { Normal, Important, Urgent };
    
    public void resetEmergencyLevel(){
    	emergencyLevel = -1;
    }
    
    public int getEmergencyLevel() { return emergencyLevel; }
    public void setEmergencyLevel(int el){
    	emergencyLevel = el;
    }
    
    public boolean hasEmergencyLevelSet(){
    	return (emergencyLevel != -1);
    }
    /////////////////////
    ...
    //xuyang status
    private String calStatusSelection = "available";

    public String getCalStatusSelection() { return calStatusSelection; }

    public void setCalStatusSelection(String selection) { calStatusSelection = selection; }

    //xuyang repeatmode
    private String calRepeatModeSelection = "DAY-OF-WEEK";

    public String getCalRepeatModeSelection() { return calRepeatModeSelection; }

    public void setCalRepeatModeSelection(String selection) { calRepeatModeSelection = selection; }
	...
	// TOOD chenyinye: allow to set different status
    public void addCalendarEntry(long startTime, long endTime, ResourceCalendar.Status status,
    		int workload, String comments) throws CalendarException{
        if (calFilterSelection.startsWith("All")) {
            ...
            if (resource != null) {
                CalendarEntry entry = new CalendarEntry(resource.getID(), startTime, endTime,
                    status, workload, getUserid(), comments);
