...
public abstract class AbstractInteraction {
    ...
    //limingyao add full-system initiator value
    public static final int AUTO_INITIATED = 2;
    ...
    public AbstractInteraction(int initiator) {
        ...
        //limigyao set the full-system distribute
        else if (initiator == AUTO_INITIATED) _initiator = initiator;
    }
    ...
    public boolean setInitiator(int i) {
    	//limingyao: add the or rule
        if ((i == USER_INITIATED) || (i == SYSTEM_INITIATED) || (i == AUTO_INITIATED)) {
            _initiator = i ;
            return true ;
        }
    ...
    public String getInitiatorString() {
    	...
    	//limingyao: modify the reture value
    ...
    //limingyao 
    public boolean isUserInitiated() { return _initiator == USER_INITIATED;}
    public boolean isAutoInitiated() { return _initiator == AUTO_INITIATED;}
    ...
    public void parseInitiator(Element e, Namespace nsYawl) throws ResourceParseException {
        ...
        //limingyao
        else if( initiator.equals("auto")) 
        	_initiator = AUTO_INITIATED; 
    }
