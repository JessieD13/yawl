...
public abstract class AbstractSelector {
	...
	protected HashMap<String, String> _params = new HashMap<String, String>(); // params
																				// used
																				// by
																				// the
																				// 'selection'
	...
	protected String toXML() {
		...
		if ((_params != null) && (!_params.isEmpty())) {
			...
			while (itr.hasNext()) {
				...
				xml.append("<value>").append(_params.get(key))
						.append("</value>");
				xml.append("</param>");
			}
			xml.append("</params>");
	...
	private boolean isExternalClass() {
		...
		return (canonicalName != null)
				&& (!canonicalName.startsWith("org.yawlfoundation"));
	}
