...
public class RuntimeCache {
	...
	protected Map<String, Element> addDataSchema(YSpecificationID specID,
			String schema) {
	...
	protected void shutdown() throws InterruptedException {
		for (UserConnection connection : _liveSessions.getAllSessions()) {
			if (connection != null) {
				...
				String id = (p != null) ? p.getUserID()
						: ResourceManager.ADMIN_STR;
	...
	protected String connectClient(String userid, String password,
			long timeOutSeconds) {
