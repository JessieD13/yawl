...
public class ResourceAdministrator {
	...
	public void assignUnofferedItem(WorkItemRecord wir, String[] pidList,
			String action) {
	...
	private void refreshWorklistedQueue() {
		...
		HashSet<Participant> pSet = ResourceManager.getInstance()
				.getOrgDataSet().getParticipants();
		for (Participant p : pSet)
			_qSet.addToQueue(WorkQueue.WORKLISTED, p.getWorkQueues()
					.getWorklistedQueues());
	}
