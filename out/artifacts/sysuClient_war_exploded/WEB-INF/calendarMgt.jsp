            ...
            <ui:html binding="#{calendarMgt.html1}" id="html1">
                ...
                <ui:body binding="#{calendarMgt.body1}" id="body1"
                    ...
                    <ui:form binding="#{calendarMgt.form1}" id="form1">
                        ...
                        <ui:panelLayout binding="#{calendarMgt.layoutPanel2}"
                                        ...
                                        style="position: absolute; height: 692px; width: 595px; top: 3px">
             ...
             <ui:button action="#{calendarMgt.btnTomorrow_action}"
              ...
              <ui:panelLayout binding="#{calendarMgt.editPanel}"
                              id="editPanel"
                              styleClass="caseMgtPanel"
                              style="position: absolute; height: 202px; top: 480px; left: 12px; width: 567px">
                ...
                <!--    <ui:checkbox binding="#{calendarMgt.cbxRepeat}"
                 ...
                 -->
                 <!-- modified by XuYang -->
				  <ui:label binding="#{calendarMgt.lblStatus}"
				  			id="lblStatus" style="left: 11px; top: 112px; position: absolute"
				  			text="Status"/>

				          <ui:dropDown binding="#{calendarMgt.cbbStatus}"
                                id="cbbStatus"
                                items="#{calendarMgt.calendarMgtStatusComboItems}"
                           
                                onChange="common_timeoutSubmitForm(this.form, 'cbbStatus');"
                                valueChangeListener="#{calendarMgt.cbbStatus_processValueChange}"
                                style="left: 60px; top: 112px; position: absolute; width: 75px"/>

				<ui:label binding="#{calendarMgt.lblRepeatMode}"
				  			id="lblRepeatMode" style="left: 150px; top: 112px; position: absolute"
				  			text="RepeatMode"/>
				  			
                <ui:dropDown binding="#{calendarMgt.cbbRepeatMode}"
                     id="cbbRepeatMode"
                     onChange="common_timeoutSubmitForm(this.form, 'cbbRepeatMode');"
                     items="#{calendarMgt.calendarMgtRepeatModeComboItems}"
                     valueChangeListener="#{calendarMgt.cbbRepeatMode_processValueChange}"
                     style="left: 230px; top: 112px; position: absolute; width: 150px"/>
                 <!-- modified by XuYang end -->
              </ui:panelLayout>
