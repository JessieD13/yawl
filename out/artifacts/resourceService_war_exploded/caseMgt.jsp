                ...
                <ui:body binding="#{caseMgt.body1}" id="body1"
                    ...
                    <ui:form binding="#{caseMgt.form1}" id="form1">
                        ...
                        <ui:panelLayout binding="#{caseMgt.layoutPanel2}"
							...
							<!-- limingyao -->
                            <ui:button action="#{caseMgt.btnPriSetting_action}"
                        ...
                        <ui:panelLayout binding="#{caseMgt.pnlDelayed}"
                            ...
                            <!-- limingyao: Add emergency level set label and radiobuttons        
                            <ui:label binding="#{caseMgt.lblDelayPriValue}"
                               for="rButtonGroup"
                               id="lblDelayPriValue"
                               style="left: 17px; top: 170px; position: absolute"
                               />
                           
                            <ui:radioButton binding="#{caseMgt.rbNormalDelay}"
                                            id="rbNormalDelay"
                                            name="rButtonGroup"
                                            style="position:absolute; left:25px; top: 170px;"
                                            selected="#{SessionBean.levelNormalDelayedRBSelected}"
                                            onClick="common_timeoutSubmitForm(this.form, 'rbNormalDelay');"
                                            label="Normal" />

                            <ui:radioButton binding="#{caseMgt.rbImportantDelay}"
                                               id="rbImportantDelay"
                                               name="rButtonGroup"             
                                               style="position:absolute; left:100px; top: 170px;"
                                               selected="#{SessionBean.levelImportantDelayedRBSelected}"
                                               onClick="common_timeoutSubmitForm(this.form, 'rbImportantDelay');"
                                               label="Important" />

                            <ui:radioButton binding="#{caseMgt.rbUrgentDelay}"
                                            id="rbUrgentDelay"
                                            name="rButtonGroup"
                                            style="position:absolute; left:190px; top: 170px;"
                                            selected="#{SessionBean.levelUrgentDelayedRBSelected}"
                                            onClick="common_timeoutSubmitForm(this.form, 'rbUrgentDelay');"
                                            label="Urgent" />-->
							<!-- **************************************** -->
                            ...
                            <ui:button action="#{caseMgt.btnDelayCancel_action}"
                                       ...
                                       id="btnDelayCancel"
                                       style="left: 155px; top: 225px"
                                       styleClass="caseMgtButton"
                                       text="Cancel"/>

                        </ui:panelLayout>
                        
                        <!-- limingyao: case emergency level setting popup panel-->
                        <ui:panelLayout binding="#{SessionBean.pnlPriSettingBlockout}"
                                        id="priSettingBlockoutPanel"
                                        styleClass="transPanel"
                                        visible="#{SessionBean.prioritySetPanelVisible}" />
	                    <ui:panelLayout binding="#{caseMgt.pnlPriority}"
                                        id="pnlPriority"
                                        styleClass="prioritySetPanel"
                                        style="position:absolute;"
                                        visible="#{SessionBean.prioritySetPanelVisible}" >

                            <ui:staticText binding="#{caseMgt.priSettingHeader}"
                                           id="priSettingHeader"
                                           styleClass="pageSubheading"
                                           style="position:absolute; left: 12px; top: 12px"
                                           text="Select the emergency level: "/>                          
                        
   
                        	<ui:radioButton binding="#{caseMgt.rbNormal}"
                                            id="rbNormal"
                                            name="rButtonGroup"
                                            style="position:absolute; left:35px; top: 45px;"
                                            selected="#{SessionBean.levelNormalRBSelected}"
                                            onClick="common_timeoutSubmitForm(this.form, 'rbNormal');"
                                            label="Normal" />

                            <ui:radioButton binding="#{caseMgt.rbImportant}"
                                               id="rbImportant"
                                               name="rButtonGroup"             
                                               style="position:absolute; left:35px; top: 75px;"
                                               selected="#{SessionBean.levelImportantRBSelected}"
                                               onClick="common_timeoutSubmitForm(this.form, 'rbImportant');"
                                               label="Important" />

                            <ui:radioButton binding="#{caseMgt.rbUrgent}"
                                            id="rbUrgent"
                                            name="rButtonGroup"
                                            style="position:absolute; left:35px; top: 105px;"
                                            selected="#{SessionBean.levelUrgentRBSelected}"
                                            onClick="common_timeoutSubmitForm(this.form, 'rbUrgent');"
                                            label="Urgent" />
                        
                            <ui:button action="#{caseMgt.btnPriSetOK_action}"
                                       binding="#{caseMgt.btnPriSetOK}"
                                       id="btnPriSetOK"
                                       style="left: 35px; top: 145px"
                                       styleClass="caseMgtButton"
                                       text="OK"/>

                            <ui:button action="#{caseMgt.btnPriSetCancel_action}"
                                       binding="#{caseMgt.btnPriSetCancel}"
                                       id="btnPriSetCancel"
                                       style="left: 155px; top: 145px"
                                       styleClass="caseMgtButton"
                                       text="Cancel"/>
