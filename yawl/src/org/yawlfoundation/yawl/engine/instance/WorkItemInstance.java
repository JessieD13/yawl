...
public class WorkItemInstance implements YInstance {
    ...
    // lincaizhao: add rst lst and lft
    ...
    //TODO limingyao : add the expiry flag
    ...
    public void close(Document completionData) {
        ...
        // lincaizhao
        regularStartTime = getRegularStartTime();
        latestStartTime = getLatestStartTime();
        latestFinishTime = getLatestFinishTime();
    ...
    public long getRegularStartTime() { 
    	if (workItem != null) return workItem.getRegularStartTime().getMillisecond(); 
    	return regularStartTime;
    }
    
    public String getRegularStartTimeAsDateString() {
    	if (getRegularStartTime() == 0) return "";
    	return dateFormatter.format(getRegularStartTime());
    }

    public void setRegularStartTime(long time) { regularStartTime = time; }

    public long getLatestStartTime() { 
    	if (workItem != null) return workItem.getLatestStartTime().getMillisecond(); 
    	return latestStartTime;
    }
    
    public String getLatestStartTimeAsDateString() {
    	if (getLatestStartTime() == 0) return "";
    	return dateFormatter.format(getLatestStartTime());
    }

    public void setLatestStartTime(long time) { latestStartTime = time; }

    public long getLatestFinishTime() { 
    	if (workItem != null) return workItem.getLatestFinishTime().getMillisecond(); 
    	return latestFinishTime;
    }
    
    public String getLatestFinishTimeAsDateString() {
    	if (getLatestFinishTime() == 0) return "";
    	return dateFormatter.format(getLatestFinishTime());
    }

    public void setLatestFinishTime(long time) { latestFinishTime = time; }

    public long getExecuteTime() { 
    	if (workItem != null) return workItem.getExecuteTime().getMillisecond(); 
    	return executeTime;
    }
    
    public String getExecuteTimeAsDateString() {
    	if (getExecuteTime() == 0) return "";
    	return formatAge(getExecuteTime());
    }

    public void setExecuteTime(long time) { executeTime = time; }
    ...
    public String toXML() {
        ...
        // lincaizhao
        xml.append(StringUtil.wrap(String.valueOf(getRegularStartTime()), "regularstarttime"));
        xml.append(StringUtil.wrap(String.valueOf(getLatestStartTime()), "lateststarttime"));
        xml.append(StringUtil.wrap(String.valueOf(getLatestFinishTime()), "latestfinishtime"));
        xml.append(StringUtil.wrap(String.valueOf(getExecuteTime()), "executetime"));
    ...
    public void fromXML(Element instance) {
        if (instance != null) {
            ...
            // lincaizhao
            regularStartTime = strToLong(instance.getChildText("regularstarttime"));
            latestStartTime = strToLong(instance.getChildText("lateststarttime"));
            latestFinishTime = strToLong(instance.getChildText("latestfinishtime"));
            executeTime = strToLong(instance.getChildText("executetime"));
