...
public class CaseInstance implements YInstance {
    ...
    public long getValidTime() { return validTime; }
    ...
    public String getValidTimeAsDateString() {
        String result = null;
        if (validTime > 0) {
            result = formatAge(validTime);
        }
        return result;
    }
    ...
    public String toXML() {
        ...
        xml.append(StringUtil.wrap(String.valueOf(validTime), "validtime"));
    ...
    public void fromXML(Element instance) {
        if (instance != null) {
            ...
            String validStr = instance.getChildText("validtime");
            if (validStr != null) validTime = new Long(validStr);
