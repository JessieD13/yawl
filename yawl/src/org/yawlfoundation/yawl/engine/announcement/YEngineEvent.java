...
public enum YEngineEvent {
    ...
    // lincaizhao: temporal timer expired event
    // TODO should broadcast?
    LS_TIMER_EXPIRED("announceLSTimerExpiry", false),
    LF_TIMER_EXPIRED("announceLFTimerExpiry", false),
    CASE_TIMEOUT("announceCaseTimeout", false)
    ;
