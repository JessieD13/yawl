...
public interface ObserverGateway {
    ...
    /**
     * Called by the engine when a latest start timer for a work item expires.
     * @param announcement the work item descriptors
     */
    void announceLSTimerExpiry(final YAnnouncement announcement);
    
    
    /**
     * Called by the engine when a latest finish timer for a work item expires.
     * @param announcement the work item descriptors
     */
    void announceLFTimerExpiry(final YAnnouncement announcement);
    
    
    /**
     * Called by the engine when a case timeouts.
     * @param yawlService the service to notify
     * @param caseID the timeout case identifier
     */
    void announceCaseTimeout(YAWLServiceReference yawlService,
    						 YIdentifier caseID);
