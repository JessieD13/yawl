...
public interface EngineGateway extends Remote {
    ...
    //limingyao: Overload launchCase with adding the emergency level
    String launchCase(YSpecificationID specID, String caseParams, URI completionObserverURI, String logDataStr, int level, String sessionHandle) throws RemoteException;
