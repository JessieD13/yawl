...
public class Marshaller {
    ...
    public static WorkItemRecord unmarshalWorkItem(Element workItemElement) {
        ...
        if (caseID != null && taskID != null && specURI != null &&
            ...
            //limingyao: expiry flag marshaller
            wir.setIsEverExpired(Boolean.parseBoolean(workItemElement.getChildText("isEverExpired")));
            ...
            // TODO lincaizhao parse temporal properties
            wir.setLatestStartTime(workItemElement.getChildText("latestStartTime"));
            wir.setExecuteTime(workItemElement.getChildText("executeTime"));
            wir.setRegularStartTime(workItemElement.getChildText("regularStartTime"));
