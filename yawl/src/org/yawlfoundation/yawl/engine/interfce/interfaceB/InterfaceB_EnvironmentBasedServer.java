...
public class InterfaceB_EnvironmentBasedServer extends HttpServlet {
    ...
    private String processPostQuery(HttpServletRequest request) {
        ...
        // lincaizhao: process temporal announcement
        else if ("announceLSTimerExpiry".equals(action)) {
        	// TODO parse parameters
        	_controller.handleLSTimerExpiryEvent(workItem);
        }
        else if ("announceLFTimerExpiry".equals(action)) {
        	// TODO parse parameters
        	_controller.handleLFTimerExpiryEvent(workItem);
        }
        else if ("announceCaseTimeout".equals(action)) {
        	// TODO parse parameters
        	_controller.handleCaseTimeoutEvent();
        }
        return "<success/>";
    }
