...
public abstract class InterfaceBWebsideController {
    ...
    // lincaizhao: handle temporal events
    // TODO pass parameters to handle stub
    /******************** TEMPORAL EVENTS ********************/
    /**
     * Receives notification from the engine that an active workitem's latest
     * start timer has expired.
     * Override this method to handle timer expiries on timed workitems.
     * @param expiredWorkItem the workitem that has an expired latest start timer
     */
    public void handleLSTimerExpiryEvent(WorkItemRecord expiredWorkItem) {}
    
    /**
     * Receives notification from the engine that an active workitem's latest
     * finish timer has expired.
     * Override this method to handle timer expiries on timed workitems.
     * @param expiredWorkItem the workitem that has an expired latest finish timer
     */
    public void handleLFTimerExpiryEvent(WorkItemRecord expiredWorkItem) {}
    
    public void handleCaseTimeoutEvent() {}
