        ...
        try {
            ...
            if (action != null) {
                if (action.equals("checkConnection")) {
                    ...
                    //limingyao: Read Emergency Level from request parameters
                   ...
                   //limingyao: Modify the if-else with adding the emergency level judgement
                    if ( levelStr != null ){
                    	msg.append(_engine.launchCase(specID, caseParams, completionObserver, logDataStr, 
                    				StringUtil.strToInt(levelStr, 0), sessionHandle));
                    }
                    ////////
