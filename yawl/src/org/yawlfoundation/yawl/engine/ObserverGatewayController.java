            ...
            public void run() {
                ...
                for (ObserverGateway gateway : getGatewaysForScheme(scheme)) {
                    switch (announcement.getEvent()) {
                        ...
                        // TODO lincaizhao handle temporal events
                        case LS_TIMER_EXPIRED: gateway.announceLSTimerExpiry(announcement); break;
                        case LF_TIMER_EXPIRED: gateway.announceLFTimerExpiry(announcement); break;
                        // ? case CASE_TIMEOUT: gateway.announceCaseTimeout(announcement); break;
                    }
                }
            }
        });
