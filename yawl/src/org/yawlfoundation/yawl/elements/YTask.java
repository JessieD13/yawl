...
public abstract class YTask extends YExternalNetElement {
    ...
    private TimePoint _versionCreateTime;
    //private TimeSpan _executeTime;
    private TimeSpan _minExecuteTime;
    private TimeSpan _maxExecuteTime;
    private TimePoint _regularStartTime;
    private TimePoint _latestStartTime;
    
    // limingyao: dynamic execute time of different cases
    private Map<String, Long> _executeTimeForCases;
    ...
    public String toXML() {
        ...
        // lincaizhao: temporal properties to xml
        if (_versionCreateTime != null) {
        	xml.append(StringUtil.wrap(String.valueOf(_versionCreateTime.getMillisecond()), "versionCreateTime"));
        }
        
        /*if (_executeTime != null) {
        	xml.append(StringUtil.wrap(String.valueOf(_executeTime.getMillisecond()), "executeTime"));
        }*/
        if (_maxExecuteTime != null) {
        	xml.append(StringUtil.wrap(String.valueOf(_maxExecuteTime.getMillisecond()), "maxExecuteTime")); 
        }
        
    	if (_minExecuteTime != null) {
        	xml.append(StringUtil.wrap(String.valueOf(_minExecuteTime.getMillisecond()), "minExecuteTime")); 
    	}
    ...
    // lincaizhao: temporal getters & setters
    public TimePoint getVersionCreateTime() {
    	return _versionCreateTime;
    }
    
    public void setVersionCreateTime(TimePoint _create) {
    	_versionCreateTime = _create;
    }
    
    public TimeSpan getMaxExecuteTime() {
    	return _maxExecuteTime;
    }
    
    public void setMaxExecuteTime(TimeSpan _time) {
    	_maxExecuteTime = _time;
    }
    
    public TimeSpan getMinExecuteTime(){
    	return _minExecuteTime;
    }
    
    public void setMinExecuteTime(TimeSpan _time){
    	_minExecuteTime = _time;
    }
    ...
    public void setLatestStartTime(TimePoint _lst) {
    	_latestStartTime = _lst;
    }
    
    public TimePoint getLatestFinishTime() {
    	return _latestStartTime.forward(_maxExecuteTime);
    }
    ...
    public void setRegularStartTime(TimePoint _rst) {
    	_regularStartTime = _rst;
    }

    //limingyao
    public Map<String, Long> getExecuteTimeForCases(){
    	return _executeTimeForCases;
    }
    
    public void setExecuteTimeForCases(Map<String, Long> et){
    	_executeTimeForCases = et;
    }
    
    public void addExecuteTimeForCases(String caseid, long executeTime){
    	_executeTimeForCases.put(caseid, executeTime);
    }
