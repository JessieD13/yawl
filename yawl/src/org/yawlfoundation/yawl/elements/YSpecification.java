...
public final class YSpecification implements Cloneable, YVerifiable {
    ...
    private TimePoint _specCreateTime;
    private TimeInterval _specValidTime;
    private TimeSpan _caseValidTime;

    //Add by Hulin
    private TimeSpan _caseMinTime;
    private TimeSpan _caseMaxTime;
    ...
    public String toXML() {
        ...
        // lincaizhao: append temporal properties to xml format
        if (_specCreateTime != null)
        	xml.append(StringUtil.wrap(String.valueOf(_specCreateTime.getMillisecond()), "specCreateTime"));
        if (_specValidTime != null) {
        	xml.append(StringUtil.wrap(StringUtil.wrap(String.valueOf(_specValidTime.getStart().getMillisecond()), "start") + 
        			StringUtil.wrap(String.valueOf(_specValidTime.getEnd().getMillisecond()), "end"), "specValidTime"));
        }
        if (_caseValidTime != null)
        	xml.append(StringUtil.wrap(String.valueOf(_caseValidTime.getMillisecond()), "caseValidTime"));
        //Hulin
        if (_caseMinTime != null)
            xml.append(StringUtil.wrap(String. valueOf(_caseMinTime.getMillisecond()), "caseMinTime"));
        if (_caseMaxTime != null)
            xml.append(StringUtil.wrap(String. valueOf(_caseMaxTime.getMillisecond()), "caseMaxTime"));
    ...
    /******** lincaizhao: getter and setter for temporal properties **********/
    public TimePoint getSpecCreateTime() {
    	return _specCreateTime;
    }
    
    public void setSpecCreateTime(TimePoint _point) {
    	_specCreateTime = _point;
    }
    
    public TimeInterval getSpecValidTime() {
    	return _specValidTime;
    }
    
    public void setSpecValidTime(TimeInterval _interval) {
    	_specValidTime = _interval;
    }
    
    public TimeSpan getCaseValidTime() {
    	return _caseValidTime;
    }
    
    public void setCaseValidTime(TimeSpan _span) {
    	_caseValidTime = _span;
    }
    /*************************************************************************/

    //Add by Hulin
    public TimeSpan getCaseMinTime() {
    	return _caseMinTime;
    }
  
    public void setCaseMinTime(TimeSpan _span) {
	   _caseMinTime = _span;
    }
  
    public TimeSpan getCaseMaxTime() {
    	return _caseMaxTime;
    }
  
    public void setCaseMaxTime(TimeSpan _span) {
    	_caseMaxTime = _span;
    }
    /************************************/
