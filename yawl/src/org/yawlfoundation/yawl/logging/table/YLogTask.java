...
public class YLogTask {
    ...
    //limingyao pesist the flag of task whether it has ever expired
    //private boolean isEverExpired;
    ...
    public boolean getIsEverExpired(){
    	return isEverExpired;
    }
    public void setIsEverExpired(boolean iee){
    	this.isEverExpired = iee;
    }*/
    ...
    public String toXML() {
        ...
        //limingyao expiry flag to xml string
        //xml.append(StringUtil.wrap(String.valueOf(isEverExpired), "isEverExpired"));
